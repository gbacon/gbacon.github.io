...
author: "Greg Bacon"
date: "2002-02-28"
journal: "The Exponent (University of Alabama in Huntsville), Vol. 33, No. 22, 2002-02-28 — Tech Talk"
...
The interesting part is that Google takes into account an ad's effectiveness (i.e., click-through rate) along with the amount of money the advertiser is willing to pay for click-throughs when ranking ads. In other words, if someone is willing to pay twice as much as you, but your ad is twice as popular, then you're on even footing with your competitor. Jockeying for position among advertisers takes place in an ongoing auction in which bidders (as with eBay) can specify a maximum price but only have to pay a cent more for click-throughs than the next lower competitor is willing to pay.
