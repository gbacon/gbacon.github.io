...
author: "Greg Bacon"
date: "2002-03-21"
journal: "The Exponent (University of Alabama in Huntsville), Vol. 33, No. 25, 2002-03-21 — Tech Talk"
description: "What if the U.S. Postal Service decreed that it would only deliver postcards after today? Such a decision wouldn't be as catastrophic as it might seem. You could still use the… (Reprint of 2000-10-19.)"
external_url: https://louis.uah.edu/exponent-2002/25
tags:
  - "Exponent"
  - "UAH"
  - "Tech Talk"
...
*[View the digitized issue in the UAH LOUIS archive](https://louis.uah.edu/exponent-2002/25).*

*This column also relates to the 2000-10-19 appearance.*
...
There is a point to the postcard analogy. Every time you send email, it's as if you've mailed a postcard with no protection from prying eyes. For those who would dismiss such concerns as paranoia, consider the FBI's Carnivore, a system in use now for eavesdropping on email correspondence (see http://www.stopcarnivore.org/). Wiretapping is supposed to require a court order, but that requirement is easy to circumvent in an environment like the Internet where information scurries unprotected from one place to another.
